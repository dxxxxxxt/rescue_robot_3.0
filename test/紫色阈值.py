...
def save_thresholds():
    ...
    config_file = os.path.join(config_dir, "hsv_thresholds_purple.json")
...
def load_thresholds():
    ...
    try:
        if os.path.exists(config_file):
            ...
            print("提示：紫色检测主要关注 H Min 和 H Max 参数")
            return False
...
print("使用说明:")
print("- 主要调整 'H Min' 和 'H Max' 参数：控制紫色范围(125-150)")
